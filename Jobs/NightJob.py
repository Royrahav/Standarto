...
class NightJob(Job):
    ...
    def create_data_frames(self):
        ...
        m_basics_df = self.read_data_frame(gd.gz_files_output_path + gd.title_basics_tsv_gz_name)
        m_ratings_df = self.read_data_frame(gd.gz_files_output_path + gd.title_ratings_tsv_gz_name)

    def act(self):
        if not self.CheckDateOfToday():
            pass
